namespace TextRPG
{
    internal class ItemManager
    {
        public ItemManager()
        {
            ...
            ItemList.Add(new(ItemType.Armor, PlayerType.Shield, "판금 갑옷\t\t", "판금으로 만들어져 튼튼한 갑옷입니다.\t", 20000, def: 30));
            ...
            ItemList.Add(new(ItemType.Weapon, PlayerType.Mage, "강철 메이스\t\t", "공수에 모두 뛰어난 메이스입니다.\t", 20000, atk: 8, def: 8));

            ItemList.Add(new(ItemType.Jewelry, PlayerType.Common, "칠 반지\t\t", "Chill한 보호 주문이 깃든 반지입니다.\t\t\t", 7777, atk: 7, def: 7, hp: 777));
        }
